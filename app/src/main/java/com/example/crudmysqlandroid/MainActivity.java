...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Stefany Hernandez");
    ...
    private void DialogConfirmacion2(){
        //startActivity(new Intent(getApplicationContext(),MainActivity.class));
        String mensaje2 = "Creado por: Stefany.Hernandez";
        dialogo = new AlertDialog.Builder(MainActivity.this);
        ...
        dialogo.setNegativeButton("Volver", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogo, int id) {
                Toast.makeText(getApplicationContext(), "github.com/hernandez", Toast.LENGTH_LONG).show();
            }
        });
        dialogo.show();
    }
